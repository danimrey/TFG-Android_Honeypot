    ...
    var handle = function(req,res,next) {
        ...
        if (table[host].count > params.limit) {
            ...
            console.log(contador);
                ...
                console.log('IP atacante: '+req.client._peername.address); 
                console.log('Puerto atacante: '+req.client._peername.port);
                console.log('IP Serv: '+req.client._sockname.address); 
                console.log('Puerto Serv: '+req.client._sockname.port);
                ...
                var log = {
                 Servicio: "HTTP",
                 AtacanteIP: req.client._peername.address,
                 AtacantePuerto: req.client._peername.port,
                 ServerIP: req.client._sockname.address,
                 ServerPuerto: req.client._sockname.port,
                 Comando: "Expulsado DDoS"
                };
